...
$request_body = json_decode('{
  ...
  "html_content": "<html><head><title></title><!-- Global site tag (gtag.js) - Google Analytics --> 
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-121874055-1"></script>
<script>
 window.dataLayer = window.dataLayer || [];
 function gtag(){dataLayer.push(arguments);}
 gtag('js', new Date());

 gtag('config', 'UA-121874055-1');
</script>
...
* [Classroom > How do I add more subusers to <?php if (isset($_SESSION['session_username']))
{
  echo "<h2 id='session_name' class='hide'>".$_SESSION["session_user_id"]."</h2>";
echo $_SESSION["session_username"];
}else{
  echo "My Account";
}
?>?](https://sendgrid.com/docs/Classroom/Basics/Account/how_do_i_add_more_subusers_to_my_account.html)
